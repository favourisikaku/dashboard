...
const AssessorDashboardNavInc = ({ SideBarVisibility }) => {
  const { baseUrl } = useContext(AppContext);
  const navigate = useNavigate();
  const [profile, setProfile] = useState([]);

  useEffect(() => {
    const evaluator_token = localStorage.getItem("evaluator_token");
    if (!evaluator_token) {
      navigate("/");
      return;
    }
  ...
  return (
    <>
      ...
      {/* <!-- <div className="offcanvas offcanvas-start" tabIndex="-1" id="offcanvasPanic" aria-labelledby="offcanvasPanicLabel">
            ...
            <div className="col-lg-12">
                <div className="mb-4">
                    ...
                    <div className="card card-body bg-light border-rad-8 border-0 mb-4">
                        ...
                        <p className="text-muted">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Deserunt id nam placeat laboriosam adipisci vel sint temporibus officiis quis quisquam.</p>
                ...
                <div className="mb-4">
                    <h4>Onboarding</h4>
                    <div className="card card-body bg-light border-rad-8 border-0 mb-4">
                        <h6 className="text-medium">Disable new users from signing up</h6>
                        <p className="text-muted">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Deserunt id nam placeat laboriosam adipisci vel sint temporibus officiis quis quisquam.</p>
...
export default AssessorDashboardNavInc;
