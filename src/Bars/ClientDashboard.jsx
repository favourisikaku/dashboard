...
const ClientDashboard = ({ SideBarVisibility }) => {
    ...
    <>
      <div className="bg-white d-lg-block d-none py-2">
        <div className="container d-flex align-items-center justify-content-between lms-heading-title">
          ...
          >
            {/* <i
              className="bi bi-wallet bi-2 cursor-pointer"
              data-bs-toggle="offcanvas"
              data-bs-target="#offcanvasPanic"
              aria-controls="offcanvasWallet"
            ></i> */}

            <Link to="/client-administrator/payment-wallet">
              <img src="/images/pricing.svg" className="img-fluid" alt="bell" />
            </Link>

            <a href="#">
              <img
                src="/images/super-admin.svg"
                className="img-fluid"
                alt="bell"
              />
            </a>
              ...
              >
                <div className="d-flex align-items-center me-2">
                  <p className="text-truncate d-lg-inline-block d-none text-medium text-gray-1 mb-0">
                    Hello, {profile?.user?.first_name || "user"}
                  </p>
                </div>
